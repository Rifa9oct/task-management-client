    ...
    return (
        <div className="flex flex-col justify-center items-center bg-yellow-50  min-h-screen">
            ...
            <div className="relative  bg-white w-full lg:w-[600px] pl-6 border shadow-lg rounded-tl-[50px] rounded-br-[50px]">
                <div className="absolute hidden lg:block -left-[235px] -top-[100px]"><img className="lg:w-[300px]" src={todo} alt="" /></div>
                <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                    <div className="form-control">
                        ...
                        <div>
                            <input type="text" {...register("title", { required: true })}
                                name="title" placeholder="task title" className="input input-sm input-warning w-full lg:w-[500px]" />
                    ...
                    <div className="form-control">
                        ...
                        <div>
                            <textarea type="text" {...register("description", { required: true })} name="description" placeholder="description" className="textarea textarea-warning w-full lg:w-[500px]" />
                    ...
                    <div>
                        ...
                        <select  {...register("priority", { required: true })} className="select select-warning w-full lg:w-[500px]">
                    ...
                    <div className="form-control">
                        ...
                        <div>
                            <input type="number" {...register("duration", { required: true })} name="duration" placeholder="type your duration days" className="input input-sm input-warning w-full lg:w-[500px]" />
                    ...
                    <div className="form-control mt-6">
                        <button type="submit" className="btn border-0 lg:w-[500px] text-white bg-gradient-to-r from-yellow-400 to-yellow-800 shadow-lg hover:bg-gradient-to-r hover:from-yellow-800 hover:to-yellow-400">Create Task</button>
                    </div>
                </form>
            </div>
        </div>
