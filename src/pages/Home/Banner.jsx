...
const Banner = () => {
    return (
        <div className="flex top-0 flex-col-reverse lg:flex-row items-center justify-between pt-[150px] lg:pt-0 md:pt-[100px] pb-[80px] lg:pb-0 md:pb-[50px] lg:h-[700px] bg-blue-50 w-full px-[150px]">
